...
const firms = defineCollection({
  ...
  schema: z.object({
    ...
    /* source_url is the firm's own bio page for that person. It was written into every profile
       and missing from this schema, so zod stripped it and the roster's link to the firm's own
       page never rendered for anybody. */
